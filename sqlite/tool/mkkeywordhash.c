...
static Keyword aKeywordTable[] = {
  ...
  { "ANALYZESQLITE",     "TK_ANALYZESQLITE",     ALWAYS,     0      },
  { "ANALYZEEXPERT",     "TK_ANALYZEEXPERT",     ALWAYS,     0      },
  { "AUTHENTICATION",    "TK_AUTHENTICATION",    ALWAYS,     0      },
  { "BLOBFIELD",         "TK_BLOBFIELD",         ALWAYS,     0      },
  { "BULKIMPORT",        "TK_BULKIMPORT",        ALWAYS,     0      },
  { "COMMITSLEEP",       "TK_COMMITSLEEP",       ALWAYS,     0      },
  { "CONSUMER",          "TK_CONSUMER",          ALWAYS,     0      },
  { "CONVERTSLEEP",      "TK_CONVERTSLEEP",      ALWAYS,     0      },
  { "COUNTER",           "TK_COUNTER",           ALWAYS,     0      },
  ...
  { "DDL",               "TK_DDL",               ALWAYS,     0      },
  { "DETERMINISTIC",     "TK_DETERMINISTIC",     ALWAYS,     0      },
  { "DISABLE",           "TK_DISABLE",           ALWAYS,     0      },
  { "DISTRIBUTION",      "TK_DISTRIBUTION",      ALWAYS,     0      },
  { "DRYRUN",            "TK_DRYRUN",            ALWAYS,     0      },
  { "EXCLUSIVE_ANALYZE", "TK_EXCLUSIVE_ANALYZE", ALWAYS,     0      },
  { "EXEC",              "TK_EXEC",              ALWAYS,     0      },
  { "EXECUTE",           "TK_EXECUTE",           ALWAYS,     0      },
  { "ENABLE",            "TK_ENABLE",            ALWAYS,     0      },
  { "FORCE",             "TK_FORCE",             ALWAYS,     0      },
  { "FUNCTION",          "TK_FUNCTION",          ALWAYS,     0      },
  { "GENID48",           "TK_GENID48",           ALWAYS,     0      },
  { "GET",               "TK_GET",               ALWAYS,     0      },
  { "GRANT",             "TK_GRANT",             ALWAYS,     0      },
  { "INCLUDE",           "TK_INCLUDE",           ALWAYS,     0      },
  ...
  { "LUA",               "TK_LUA",               ALWAYS,     0      },
  { "LZ4",               "TK_LZ4",               ALWAYS,     0      },
  { "MANUAL",            "TK_MANUAL",            ALWAYS,     0      },
  { "MERGE",             "TK_MERGE",             ALWAYS,     0      },
  { "NEXTSEQUENCE",      "TK_CTIME_KW",          ALWAYS,     0      },
  { "NONE",              "TK_NONE",              ALWAYS,     0      },
  { "OP",                "TK_OP",                ALWAYS,     0      },
  { "OPTION",            "TK_OPTION",            ALWAYS,     0      },
  { "OPTIONS",           "TK_OPTIONS",           ALWAYS,     0      },
  { "ODH",               "TK_ODH",               ALWAYS,     0      },
  { "OFF",               "TK_OFF",               ALWAYS,     0      },
  { "PAGEORDER",         "TK_PAGEORDER",         ALWAYS,     0      },
  { "PARTITIONED",       "TK_PARTITIONED",       ALWAYS,     0      },
  { "PASSWORD",          "TK_PASSWORD",          ALWAYS,     0      },
  { "PAUSE",             "TK_PAUSE",             ALWAYS,     0      },
  { "PERIOD",            "TK_PERIOD",            ALWAYS,     0      },
  { "PENDING",           "TK_PENDING",           ALWAYS,     0      },
